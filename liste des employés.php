...
<body>
    ...
    <div class="liste-employé">
        ...
        <td>
            ...
            <i class="fas fa-edit" id="editIcon_"></i> 
            </a>
            
            <a href="désactiver un employé.php?id= <?= $employe['id_employe'] ?>&nom=<?= $employe['nom'] ?>&prenom=<?= $employe['prenom'] ?>&fonction=<?= $employe['fonction'] ?>&matricule assure=<?= $employe['matricule assure'] ?>&matricule interne=<?= $employe['matricule interne'] ?>&date naissance=<?= $employe['date de naissance'] ?>"><i class="fa fa-trash" aria-hidden="true" style="color: red;"></i>
            </a>
